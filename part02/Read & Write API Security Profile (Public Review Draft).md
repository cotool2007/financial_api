...
shall support signed ID Tokens; and
...
shall support [OAUTB] or [MTLS] as a holder of key mechanism;
should require both JWS signed and JWE encrypted ID Tokens to be returned from endpoints
for write operations.
...
shall support the provisions specified in clause 6.2.1 Financial API - Part 1: Read Only API Security Profile;
...
IdP confusion attack reported in SoK: Single Sign-On Security – An Evaluation of OpenID Connect is this kind of attack.
